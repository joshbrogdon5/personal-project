...
import './Multivitamins.css';


class Multivitamins extends Component {
    constructor(){
        super()
            this.state = {
                quantity: ''
    ...
    render(){
        ...
        let multivitaminsDisplay = this.props.multivitamins.map((element,i) => {
            return(
...
export default connect(mapStateToProps)(Multivitamins);
